...
# @Software: PyCharm
# 作用      :将多个json文件转为一个json文件，是swin transformer需要的标签格式
# -*- coding:utf-8 -*-
...
labelme_json = glob.glob(r'D:\project\dataset\mcUAVdateset\label\labelme\test/*.json')
# labelme_json=['./1.json']

# labelme2coco(labelme_json, r'D:\Users\80080947\Desktop\yxLocalWork\ObjectDetection\data\Json\instances_train.json')
labelme2coco(labelme_json, r'D:\project\dataset\mcUAVdateset\label\labelme\instances_test.json')
