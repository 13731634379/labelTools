...
# @File    : voc2coco2.py
# @Software: PyCharm
# 作用      :voc转coco（严格按照 PRE_DEFINE_CATEGORIES,即只保留需要的类别的标签）
...
START_BOUNDING_BOX_ID = 1  #标注框起始id
PRE_DEFINE_CATEGORIES = {"bicycle": 0,"car": 1,"person": 2} #标注框类别 （有则按顺序，实际有多的会按序号往后排）
...
if __name__ == '__main__':
    ...
    #     xml_list, xml_dir, output_json
    xml_list=''
    xml_dir='D:/project/1/Annotations'
    json_file='D:/project/1/voc_train.json'
