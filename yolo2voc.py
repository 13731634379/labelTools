...
if __name__ == "__main__":
    image_dir='D:/project/dataset/mcUAVdateset/img/train'
    text_dir='D:/project/dataset/mcUAVdateset/label/yolo/train'
    classes_path='D:/project/dataset/mcUAVdateset/classes.txt'
    # yolo2voc(sys.argv[1], sys.argv[2], None)
    yolo2voc(image_dir, text_dir , classes_path)